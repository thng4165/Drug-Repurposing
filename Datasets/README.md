...
We calculate molecular similarities using various fingerprint (FP) types to construct features for the model, employing either the Tanimoto or cosine similarity methods.
